...
🆕 **VOLLEDIG UITGEBREID + WERKORDER INTEGRATIE V4.0 + CLONE FUNCTIE V4.6**

## Overzicht

Volledig geïntegreerd boekhoudsysteem met offertes, facturen, grootboekrekeningen, BTW-overzicht, journaalposten en digitaal dossier. MKB-ready en NL-compliant.
...
🆕 **NIEUWE MODULE - MKB-READY, NL-COMPLIANT**
🆕 **V5.4: KASSA VERKOPEN TAB & KLIKBARE FACTUREN**
...
🆕 **V5.4: KLIKBARE FACTUREN + FINANCIEEL OVERZICHT**
...
🆕 **V5.4: NIEUWE TAB VOOR KASSA TRANSACTIES**
